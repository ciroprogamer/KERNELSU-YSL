...
ui_print "  ✓ KPM (Kernel Patch)"
ui_print "  ✓ Backported stuff I dont remember"
ui_print "  ✓ Storm Breaker Source"
ui_print " "
ui_print "    NOTES:"
ui_print "     SusFs integrated (KernelSU next made it possible, sukisu gave problems)"
ui_print "     ⓘ KPM support is untested(may brick your phone if you actually use it, or may not, idk)"
ui_print "     If you have time and a kind heart, star https://github.com/ciroprogamer/KERNELSU-YSL "
ui_print " "
