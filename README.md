# KSU-NEXT + SUSFS 2.0 – Xiaomi ysl (Redmi S2 / Redmi Y2)

**UNOFFICIAL PORT**  
This is **NOT an official implementation of KernelSU-Next or KernelSU**.  
...
KernelSU / KernelSU-NEXT  code is used under its original license.
